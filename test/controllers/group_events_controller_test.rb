...
class GroupEventsControllerTest < ActionController::TestCase
  ...
  test "should create group_event" do
    assert_difference('GroupEvent.count') do
      post :create, group_event: { deleted: @group_event.deleted, description: @group_event.description, end: @group_event.end, name: @group_event.name, published: @group_event.published, start: @group_event.start }
    end
  ...
  test "should update group_event" do
    patch :update, id: @group_event, group_event: { deleted: @group_event.deleted, description: @group_event.description, end: @group_event.end, name: @group_event.name, published: @group_event.published, start: @group_event.start }
    assert_redirected_to group_event_path(assigns(:group_event))
  end
